# Contributing to Renn Baileys

Thanks for your interest in contributing! Renn Baileys is a fork of
...
- Include: Node.js version, `@rennshit/baileys` version, a minimal reproduction,
...
```bash
git clone https://github.com/rennshit/baileys.git
cd baileys
npm install
npm run build:tsc
npm test
